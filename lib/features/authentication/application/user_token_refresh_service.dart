...
import 'package:sp8/features/authentication/data/user_metadata_repository.dart';
  ...
  void _init() {
    ref.listen<AsyncValue<AppUser?>>(authStateChangesProvider, (previous, next) {
      ...
      if (user != null) {
        ...
        _subscription =
            ref.read(userMetadataRepositoryProvider).watchUserMetadata(user.uid).listen((refreshTime) async {
